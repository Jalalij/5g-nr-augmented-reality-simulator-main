...
% Copyright 2020-2021 The MathWorks, Inc.
    ...
    properties (Access = public)
        ...
        StatTxDataBytes = 0;
        % StatTxVideoFrameBytes Number of bytes belonging to a video frame sent by RLC to MAC layer
        StatTxVideoFrameBytes = 0;
        % StatTxVideoFrameTypes Video frame type sent by RLC to MAC layer
        StatTxVideoFrameTypes = [];
        % StatTxPortionOfFrame Video frame portion sent by RLC to MAC layer
        StatTxPortionOfFrame = [];
        % Remaining TTL of the TXed data
        StatTxTTL = [];
    ...
    methods (Access = public)
        ...
        function registerPDCPReceiverFcn(obj, rxForwardFcn)
        ...
        function stats = getStatistics(obj)
            ...
            stats = [obj.StatTxDataPDU; obj.StatTxDataBytes; obj.StatReTxDataPDU; ...
                ...
                obj.StatTimerReassemblyTimedOut; obj.StatTimerStatusProhibitTimedOut; obj.StatTxVideoFrameBytes; {obj.StatTxTTL}; {obj.StatTxVideoFrameTypes}; {obj.StatTxPortionOfFrame}];
        end
    end
end

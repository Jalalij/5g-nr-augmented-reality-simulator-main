classdef hNRGNBMAC < hNRMAC
    ...
    methods
        function obj = hNRGNBMAC(simParameters)
            ...
            obj.LCHBufferTTL = cell(numUEs, obj.MaxLogicalChannels);
            obj.LCHBufferPDB = cell(numUEs, obj.MaxLogicalChannels);
            obj.LCHBufferFrameType = cell(numUEs, obj.MaxLogicalChannels);
            obj.LCHBufferAppID = cell(numUEs, obj.MaxLogicalChannels);
            obj.LCHBufferPortionOfFrame = cell(numUEs, obj.MaxLogicalChannels);
        ...
        function resourceAssignments = runDLScheduler(obj)
            ...
            resourceAssignments = runDLScheduler(obj.Scheduler, obj.TimingInfo, obj.LCHBufferTTL, obj.LCHBufferPDB, obj.LCHBufferAppID, obj.LCHBufferFrameType, obj.LCHBufferPortionOfFrame);
        ...
        function updateBufferStatus(obj, lcBufferStatus)
            ...
            obj.LCHBufferTTL{lcBufferStatus.RNTI, lcBufferStatus.LogicalChannelID} = ...
                lcBufferStatus.BufferTTL;
            obj.LCHBufferPDB{lcBufferStatus.RNTI, lcBufferStatus.LogicalChannelID} = ...
                lcBufferStatus.BufferPDB;
            obj.LCHBufferFrameType{lcBufferStatus.RNTI, lcBufferStatus.LogicalChannelID} = ...
                lcBufferStatus.BufferFrameType;
            obj.LCHBufferAppID{lcBufferStatus.RNTI, lcBufferStatus.LogicalChannelID} = ...
                lcBufferStatus.BufferAppID;
            obj.LCHBufferPortionOfFrame{lcBufferStatus.RNTI, lcBufferStatus.LogicalChannelID} = ...
                lcBufferStatus.PortionOfFrame;
        end
    end

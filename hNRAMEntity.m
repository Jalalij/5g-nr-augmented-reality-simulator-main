...
% Copyright 2020-2021 The MathWorks, Inc.
    ...
    methods(Access = public)
        function obj = hNRAMEntity(config)
            ...
            obj.TxNext = randi([0 obj.TotalTxSeqNum-1]); % it can happen that an UE receives data from a different cell with the same SN -> erroneous reception
        ...
        function dequeueSDU(obj, header)
            % no dequeuing for RLC AM mode, transmitter expects delivery of
            % frame
            return
        end
        ...
        function handleTimerTrigger(obj)
            %handleTimerTrigger Process 1 microsecond timer tirgger
            ...
            if obj.PollRetransmitTimeLeft > 0
                ...
                obj.PollRetransmitTimeLeft = obj.PollRetransmitTimeLeft - 0.001;
            ...
            if obj.StatusProhibitTimeLeft > 0
                ...
                obj.StatusProhibitTimeLeft = obj.StatusProhibitTimeLeft - 0.001;
                % Check whether the status prohibit timer is expired
                if obj.StatusProhibitTimeLeft == 0
                    obj.StatTimerStatusProhibitTimedOut = obj.StatTimerStatusProhibitTimedOut + 0.001;

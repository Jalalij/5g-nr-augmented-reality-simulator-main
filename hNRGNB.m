...
% Copyright 2019-2022 The MathWorks, Inc.
    ...
    methods (Access = public)
        function obj = hNRGNB(param)
            ...
            % Initialize PDCP entities cell array
            obj.PDCPEntities = cell(param.NumUEs, obj.MaxDataRadioBearers);
            % Create gNB SDAP instances
            obj.SDAPEntity = cell(param.NumUEs, 1);

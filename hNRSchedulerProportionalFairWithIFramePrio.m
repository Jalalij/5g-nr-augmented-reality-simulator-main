classdef hNRSchedulerProportionalFairWithIFramePrio < hNRScheduler
    ...
    methods
        function obj = hNRSchedulerProportionalFairWithIFramePrio(simParameters)
            ...
            if isfield(simParameters, 'IFramePrioWeight')
                obj.IFramePrioWeight = simParameters.IFramePrioWeight;
            end
            ...
            for i = 1:length(schedulerInput.eligibleUEs)
                ...
                if(bufferStatus > 0) % Check if UE has any data pending
                    if schedulerInput.LinkDir == 0 % DL
                        ...
                        pfWeightageFull = achievableDataRate/pastDataRate.*((frameType== 2)*(obj.IFramePrioWeight)+1);

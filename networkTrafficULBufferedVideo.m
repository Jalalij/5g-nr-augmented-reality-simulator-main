classdef networkTrafficULBufferedVideo < comm_sysmod.internal.ConfigBaseHandle
    ...
    methods       
        function obj = networkTrafficULBufferedVideo(varargin)
            obj@comm_sysmod.internal.ConfigBaseHandle(varargin{:});

            obj.pPayloadGenerationCountdown = rand()*obj.PayloadPeriodicity;
        end
    ...
    methods(Access = private)
        ...
        function generateNewPayload(obj)
            ...
            obj.pLatencies = [obj.pLatencies; ones(segmentsCount,1) * obj.DataTimeOffset];
        ...
        function dt = getNextInvokeTime(obj)
            if numel(obj.pTimeDeltas) == 1
                ...
                obj.pLatencies(end+1) = obj.pLatencies(end)+obj.pPayloadGenerationCountdown;
            ...
            dt = obj.pTimeDeltas(1); % Add jitter
        end
    end
end
